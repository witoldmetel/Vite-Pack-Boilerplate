    ...
    <div className='showcase'>
      ...
      <section className='section section-main'>
        <a
          ...
          data-lax-opacity='(vh*0.8) 1, 0 0' rel='noreferrer'
        />
        <a
        ...
        <div className='content'>
          <div className='lax' data-lax-translate-y='0 0, vh -200'>
            ...
            <p>
							This is a minimal boilerplate using React and TypeScript along
							with Sass support. It&lsquo;s also possible to config firebase and
							use Tailwind low-level utility classes. Good for small projects
							and prototyping.
            </p>
          </div>
          <div className='lax' data-lax-translate-y='0 0, vh -200'>
            ...
            <p>
							In case of issues and questions, feel free to add the question
							into{' '}
              <a
                href='https://github.com/witoldmetel/TS-Parcel-Boilerplate/issues'
